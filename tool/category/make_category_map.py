...
앱 저장소만 clone 하면 256개를 재생성할 수도, 근거를 검토할 수도, 행정구역 개편 전후를
...
PLANNED_LANDMARKS = '''
11170 28710 28720 41115 41670 51210 51760 43720 43800 44760 44150 30200 30110
36110 52190 52800 12150 12210 47130 47170 27140 27710 48220 48890 26410 26350
31710 31170 50110 41610 41830 41820 28245 26200 48170 47940
'''.split()
...
# ── 서울특별시 25 ──────────────────────────────────────────────
# 전부 도시다. 반복은 카테고리를 흩뜨리지 않고 도시 장면의 변형으로 푼다
# (2026-08-13 사용자 결정).
put('''11110 11140 11170 11200 11215 11230 11260 11290 11305 11320 11350 11380
...
# ── 제주특별자치도 2 ───────────────────────────────────────────
put('50110', 'island', '제주도 — 돌하르방 랜드마크의 폴백')
put('50130', 'sea', '중문·서귀포 해안')
...
def main():
    ...
    # 4. **모든 행에 근거가 있어야 한다.**
    #    처음에는 온천·유적·강만 검사했는데, 사용자 결정은 256개 행마다 근거였다.
...
def _dart(codes):
    ...
    w('/// 시군구 코드 → 카테고리. 랜드마크가 있는 지역도 폴백으로 가진다.\n')
